...
class _SymptomCardGridState extends State<SymptomCardGrid> {
  ...
  // Explicitly declare `imgPath` as a non-nullable `String`
  final List<Map<String, String>> symptoms = const [
    {
      "symptom": "Fever",
      "desc":
          "A temperature that's higher than normal.\nTypically around 98.6°F (37°C)",
      "imgPath": "assets/symptoms/high_fever.png",  // This is non-nullable
    },
    {
      "symptom": "Sore Throat",
      "desc":
          "A sore throat is a painful, dry, or scratchy feeling in the throat.",
      "imgPath": "assets/symptoms/sore_throat.png",  // This is non-nullable
    },
    {
      "symptom": "Dry Cough",
      "desc": "A cough that doesn't bring up mucus.",
      "imgPath": "assets/symptoms/cough.png",  // This is non-nullable
    },
    {
      "symptom": "Fatigue",
      "desc":
          "You have no energy, no motivation and overall feeling of tiredness.",
      "imgPath": "assets/symptoms/headache.png",  // This is non-nullable
    },
    {
      "symptom": "Runny Nose",
              ...
              child: AnimatedContainer(
                ...
                child: LayoutBuilder(
                  builder: (ctx, constraint) => Column(
                    ...
                    children: <Widget>[
                      // Using `!` to assert that `imgPath` is non-null
                      Image(
