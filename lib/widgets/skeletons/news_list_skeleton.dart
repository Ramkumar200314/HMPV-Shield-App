...
class _NewsListLoaderState extends State<NewsListLoader>
  ...
  late AnimationController _controller;  // Use 'late' to initialize it later
    ...
    return FadeTransition(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          // Duplicate the container code for additional skeleton loaders
          // ... (Repeat the above container code as needed)
        ],
      ),
    );
  }
